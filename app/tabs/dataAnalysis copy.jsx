        ...
        <ScrollView style={styles.container}>
            ...
            <View style={styles.cardsContainer}>
                {Object.entries(cardarr).map(([ledger, sum]) => (
                    <View style={styles.card} key={ledger}>
                        ...
                        <View style={styles.icon}>
                            <View
                                style={[
                                    styles.circle,
                                    {
                                        background: `conic-gradient(#034972 ${isNaN(Math.floor((sum / cardarr['total']) * 100))
                                                ? 0
                                                : Math.floor((sum / cardarr['total']) * 100) * 3.6
                                            }deg, #afbbcb 10.8deg)`,
                                    },
                                ]}
                            >
                                <Text style={styles.percentage}>
                                    {isNaN(Math.floor((sum / cardarr['total']) * 100))
                                        ? 0
